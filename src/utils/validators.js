...
const ERROR_MESSAGES = {
  ...
  FLIGHT_NUMBER: 'Flight number must be a 2-character airline code followed by 4 digits (e.g., AA1234, F91234)',
  AIRLINE_CODE: 'Airline code must be 2 characters (e.g., AA, F9)',
